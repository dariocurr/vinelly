...
<?php
	...
	$i = 0;
	if($_GET['remove'] > 0) {
		$query2 = "DELETE FROM admin WHERE id = ".$_GET['remove'];
...
<html lang="it">
  <head>
    ...
    <title>Pannello amministratore - Amministratori</title>
              ...
              <tbody>
				...
				?>
						<tr>
							...
							<td>
								<a class="mt-2 move-button" href="admin.php?remove=<?php echo $row['id']?>">
